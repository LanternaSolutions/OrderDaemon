 ...
 * - 'test': Events used for testing and validation purposes
 *
 ...
 * - category: Log category (core, debug, custom)
 *
 * SUMMARY TEMPLATES:
 * =================
 *
 ...
 *
 * TEST EVENTS: Testing and validation events
 * - Used for comprehensive testing scenarios
 * - Cover various status types and edge cases
 * - Help validate the logging system functionality
 *
 * EXTENSIBILITY:
 * =============
 *
 ...
 *         @type string $category         Log category: 'core', 'debug', or 'custom'.
 *     }
 * }
 *
 * @example
...
function odcm_get_log_event_types(): array
{
    ...
    // Allow extensions to add their own event types
    return apply_filters('odcm_log_event_types', $core_events);
}
